...
let LabelAccess = require('./../middlewares/LabelAccess');
 ...
 * @security JWT
 */
router.get('/:id', token, LabelAccess.readRights(), function(req, res) {
 ...
 * @security JWT
 */
router.put('/:id', token, LabelAccess.updateRights(), function(req, res) {
 ...
 * @security JWT
 */
router.delete('/:id', token, LabelAccess.updateRights(), function(req, res) {
